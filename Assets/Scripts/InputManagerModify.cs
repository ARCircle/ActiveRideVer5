...
// from http://ftvoid.com/blog/post/858
//-------------------------------------------------------------------------
public class InputManagerModify : AssetPostprocessor
{
    // Axisタイプ
...
";
    ...
    public static void EmitAssetsData(){
    ...
    {
        // InputManagerの変更チェック
        var inputManagerPath = Array.Find(importedAssets, path => Path.GetFileName(path) == @"ProjectSettings\InputManager.asset");
